...
export default function Dashboard() {
  ...
  return (
    <div className="container mx-auto p-4 space-y-4">
      ...
      <div className="h-24 bg-gray-50 rounded-lg mb-4"></div>
            ...
            <CardContent>
              ...
              <Table>
                ...
                {paginatedData.map((site) => (
                    ...
                    <TableCell className="text-center">{site.views.toLocaleString()}</TableCell>
                    <TableCell className="text-center">{site.likes.toLocaleString()}</TableCell>
                    <TableCell className="text-center">{new Date(site.published).toLocaleDateString('en-US', {
                        month: 'long',
                        day: 'numeric',
                        year: 'numeric'
                    })}</TableCell>
