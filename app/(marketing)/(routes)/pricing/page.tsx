  ...
  return (
    <div className="w-full px-4 md:px-0">
      ...
      <div className="relative max-w-5xl mx-auto mt-8">
        {/* Cards Grid */}
        <div className="grid md:grid-cols-3 gap-0 border rounded-2xl overflow-hidden border-zinc-200">
          ...
          <Card className="border-0 rounded-none px-8 py-12 flex flex-col">
            <CardContent className="p-0 flex-1 flex flex-col">
              <div className="flex-1">
                ...
                <p className="text-zinc-600 mb-8">For individuals interested in improving their reach</p>
          ...
          <div className="md:hidden absolute left-1/2 -translate-x-1/2 z-30" style={{ top: "calc(33.333%)" }}>
            <div className="bg-zinc-900 text-white px-6 py-2 rounded-full text-sm whitespace-nowrap">Most Popular</div>
          </div>

          {/* Pro Tier */}
          <Card className="border rounded-none sm:rounded-none md:rounded-none px-8 py-12 bg-orange-50 flex flex-col relative z-10">
            <CardContent className="p-0 flex-1 flex flex-col">
              <div className="flex-1">
                <h2 className="text-2xl font-bold mb-4">Pro</h2>
                <p className="text-zinc-600 mb-8">For individuals or small teams creating content at scale</p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center gap-3">
                    <div className="bg-orange-100 rounded-full p-1">
                      <Check className="h-4 w-4 text-orange-500" />
              ...
              <Button className="w-full bg-orange-500 hover:bg-orange-500 text-white">Try Citrus Free</Button>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 rounded-none px-8 py-12 flex flex-col">
            <CardContent className="p-0 flex-1 flex flex-col">
              <div className="flex-1">
                ...
                <p className="text-zinc-600 mb-8">For organizations serious about driving pipeline</p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center gap-3">
                    <div className="bg-orange-100 rounded-full p-1">
                      <Check className="h-4 w-4 text-orange-500" />
